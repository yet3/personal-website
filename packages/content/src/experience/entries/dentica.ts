...
export default defineExperience("Dentica", {
  ...
  skills: SKILLS,
  description:
    "Desktop patient management system for a dental practice, covering scheduling, procedure tracking, and automated SMS notifications.",
  contentBlocks: [
    "Partnered with a dentist to design and refine a user-friendly patient management system.",
    "Built and iterated on a desktop app for appointment scheduling, procedure tracking, and real-time updates.",
    "Integrated an SMS API through cloud functions to automate patient notifications and manage scheduling changes.",
  ],
});
