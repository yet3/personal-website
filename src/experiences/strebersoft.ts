...
export default defineExperience("STREBER SOFT", {
	...
	contentBlocks: [
		...
		"Extended an ERP system for a metal manufacturing plant. Worked on a product ordering system. Maintained and implemented new features for a desktop app based on user feedback.",
